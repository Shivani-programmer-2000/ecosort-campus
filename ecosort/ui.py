...
def sections(author: str) -> str:
    ...
    steps = [
        ...
        ("Retrieval", "The closest passages in the rules and the campus guide are found (RAG)."),
    ...
    return (
        ...
        '<section class="eco-band"><h2>Built with IBM Bob and IBM Granite</h2><div class="eco-two">'
        ...
        'every change.</p></div>'
        '<div><h3>Granite answers</h3><p>When connected, the app uses IBM Granite models through watsonx.ai, with '
        'retrieval-augmented generation so answers stay tied to the rules. The source code, tests and evaluation are in the '
        'project repository.</p></div></div></section>'
