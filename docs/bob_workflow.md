...
is IBM Granite plus RAG at **run time**. A human reviews everything Bob produces.
...
**Plan**
> Read README.md and docs/architecture.md. Suggest three improvements to the RAG pipeline for a campus waste-segregation assistant and list the files each would touch.
